...
$registraion_date = $_POST['registraion_date'];
  if (!empty($fname) && !empty($user) && !empty($email) && !empty($password)) {
    ...
    $query = "INSERT INTO users(full_name,user_name,email,password,active, registraion_date)
    VALUES ('$fname','$user','$email','$hashed_password','$active', '$registraion_date')";
    ...
    echo "<br> All fields are required, please insert your data";
  }
}
?>
									...
									<form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="first-name" name="full_name" required="required" class="form-control " name="full_name">
											</div>
										</div>
										<div class="item form-group">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="Date" id="registraion_date" name="registraion_date" required="required" class="form-control">
											</div>
										</div>
										...
										<div class="item form-group">
											<div class="col-md-6 col-sm-6 offset-md-3">
												<a href="addUser.php" class="btn btn-primary" >Cancel</a>
